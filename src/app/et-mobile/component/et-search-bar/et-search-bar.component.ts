...
@Component({
  selector: 'et-search-bar',
  templateUrl: './et-search-bar.component.html',
  styleUrls: ['./et-search-bar.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => EtSearchBarComponent),
      multi: true
    }
  ],
  animations: [
...
export class EtSearchBarComponent implements OnInit, AfterViewInit, AfterViewChecked, OnDestroy, ControlValueAccessor {
  prefixCls: string = 'et-search';
  clearCls: object;
  wrapCls: object;
  cancelCls: object = {
