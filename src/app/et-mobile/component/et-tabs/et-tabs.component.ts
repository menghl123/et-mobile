...
import {EtTabComponent} from './et-tab/et-tab.component';
...
@Component({
  selector: 'et-tabs',
  templateUrl: './et-tabs.component.html',
  styleUrls: ['./et-tabs.component.scss']
})
export class EtTabsComponent implements DoCheck, AfterContentInit {
  prefixCls: string = 'et-tabs';
  ...
  @ContentChildren(EtTabComponent, {descendants: true})
  tabPanes: QueryList<EtTabComponent>;
  ...
  @Input()
  tabPanesComponent: QueryList<EtTabComponent> = null;
  ...
  @HostBinding('class.et-tabs')
  amTabs: boolean = true;
  @HostBinding('class.et-tabs-top')
  amTabsTop: boolean = true;
  @HostBinding('class.et-tabs-left')
  amTabsLeft: boolean = false;
  @HostBinding('class.et-tabs-right')
  amTabsRight: boolean = false;
  @HostBinding('class.et-tabs-bottom')
  amTabsBottom: boolean = false;
  @HostBinding('class.et-tabs-vertical')
  amTabsVertical: boolean = false;
  @HostBinding('class.et-tabs-horizontal')
  ...
  getCurrentTabPanes(): QueryList<EtTabComponent> {
  ...
  private selectTabPane(index: number) {
    ...
    this.getCurrentTabPanes().forEach((tabPane: EtTabComponent, indexKey: number) => {
