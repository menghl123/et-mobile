...
@Component({
  selector: 'et-tab',
  templateUrl: './et-tab.component.html',
  styleUrls: ['./et-tab.component.scss'],
  host: {
...
export class EtTabComponent {
  prefixCls: string = 'et-tabs-pane';
  ...
  @HostBinding('class.et-tabs-pane-wrap')
  paneWrap: boolean = true;

  @HostBinding('class.et-tabs-pane-wrap-active')
  get wrapActive(): boolean {
    return this.active;
  }

  @HostBinding('class.et-tabs-pane-wrap-inactive')
