...
import {EtCarouselItemComponent} from './et-carousel-item/et-carousel-item.component';
import * as touchEvent from '../../utils/touch-event';

@Component({
  selector: 'et-carousel',
  templateUrl: './et-carousel.component.html',
  styleUrls: ['./et-carousel.component.scss']
})
export class EtCarouselComponent implements AfterViewInit, OnDestroy {
  slideHeight: number;
  touchObject;
  style = {
    height: 'auto',
  ...
  @ContentChildren(EtCarouselItemComponent)
  items: QueryList<EtCarouselItemComponent>;
  ...
  @HostBinding('class.et-am-carousel')
  carouselWrapper: boolean = true;
  @HostBinding('class.et-carousel')
  ...
  initCarouselSize() {
    ...
    this.slideHeight = nativeElement.querySelector('et-carousel-item').clientHeight;
  ...
  ngAfterViewInit() {
    ...
    const nativeElement = this._ele.nativeElement;
    const targetNode = nativeElement.querySelector('et-carousel-item');
    const config = {attributes: true, childList: true, subtree: true};
    const callback = (mutationsList) => {
      for (const mutation of mutationsList) {
        if (mutation.type === 'attributes') {
          if (this.slideHeight !== nativeElement.querySelector('et-carousel-item').clientHeight) {
            this.initCarouselSize();
            this.getListStyles();
          }
        }
