...
@Component({
  selector: 'et-grid-view',
  templateUrl: './et-grid-view.component.html',
  styleUrls: ['./et-grid-view.component.scss']
})
export class EtGridViewComponent implements OnInit {
  wrapCls = {};
  itemCls = {};
  carouselProps = {
    dots: false,
  ...
  @HostBinding('class.et-grid')
  amGrid: boolean = true;

  @HostBinding('class.et-grid-square')
  get amGridSquare(): boolean {
    return true === this.square;
  }

  @HostBinding('class.et-grid-line')
  get amGridLine(): boolean {
    return true === this.hasLine;
  }

  @HostBinding('class.et-grid-carousel')
